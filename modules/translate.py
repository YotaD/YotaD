...
# coding=utf-8
"""
translate.py - Yota Translation Module
...
def tr(m5, context): 
   ...
   if (len(phrase) > 350) and (not context.admin): 
      return m5.reply('Phrase must be under 350 characters.')
   ...
   if input != output: 
      ...
      m5.reply(msg)
   else: m5.reply('Language guessing failed, so try suggesting one!')
